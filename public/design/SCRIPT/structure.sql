...
--
-- Host: 127.0.0.1    Database: superlative_db
-- ------------------------------------------------------
...
CREATE TABLE `product_imgs` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `product_imgs_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sequelizemeta` VALUES ('20250806170751-create-sizes.js'),('20250806170905-create-product-categories.js'),('20250806171006-create-user-categories.js'),('20250806171252-create-users.js'),('20250806171337-create-products.js'),('20250806171528-create-orders.js'),('20250806173156-create-product-sizes.js'),('20250806173248-create-order-details.js'),('20250806174220-create-user-imgs.js'),('20250806174253-create-product-imgs.js');
...
-- Dump completed on 2025-08-07 15:23:32
