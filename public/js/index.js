...
function showSomeProducts (clothesSelected) {
    ...
    const randomClothes = shuffledClothes.slice(0, 10); // Tomamos solo 10 prendas del array mezclado con .slice
                            ...
                            <a href="./productDetail.html">   
                                ...
                                <div class="productInfo">
                                    ...
                                    <div class="productPrice">
                                        <p>$ ${cloth.price}</p>
                                        <p class="cuotas"><b>3 cuotas sin interes de $ ${Math.round(cloth.price/3).toFixed(2)} </b></p>    
                                    </div>
                                </div>
                             </a>
                            `
