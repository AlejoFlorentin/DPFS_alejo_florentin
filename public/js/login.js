document.addEventListener('DOMContentLoaded' , function (){ // El evento DOMContentLoaded es un evento en JavaScript que se dispara cuando el documento HTML inicial ha sido completamente cargado y analizado por el navegador,
